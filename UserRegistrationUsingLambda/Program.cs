...
namespace UserRegistrationUsingLambda
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Enter Password (Rule1-Minimum 8 in length):");
            ...
            Console.WriteLine("Enter Password (Rule2-Atleast one uppercase) :");
            ...
            Console.WriteLine("Enter Password (Rule3-Atleast 1 number) :");
            ...
            Console.WriteLine("Enter Password (Rule4-One Special Character) :");
