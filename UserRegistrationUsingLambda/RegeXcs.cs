...
namespace UserRegistrationUsingLambda
{
    public class RegeX
    {
        ...
        public static string REGEX = "^[A-Z][a-z]*[ ]?[a-z]+$";
        ...
        //UC-2
        //pattern for valid name
        public static string LastNameREGEX = "^[A-Z][a-z]*[ ]?[a-z]+$";
        ...
        public static string EmailREGEX = "^[a-zA-Z0-9]+([.#_+-][a-zA-Z0-9]+)*[@][a-zA-Z0-9]+[.][a-zA-Z]{2,3}([.][a-zA-Z]{2})?$";
        ...
        public static string MobileNumREGEX = "^[0-9]{2}[ ][6-9][0-9]{9}$";
        ...
        public static string Condition4REGEX = "^(?=.*[a-z])(?=.*[0-9])(?=.*[!@#?$&])(?=.*[A-Z])[a-zA-Z0-9!@#?$&]{8,}$";
